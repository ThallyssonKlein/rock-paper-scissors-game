package com.srmasset.domain.person.service;

import com.srmasset.adapters.outbound.database.OutboundConfigAdapter;
import com.srmasset.ports.outbound.database.IdentifierType;
import com.srmasset.domain.person.error.InvalidIdentifierException;
